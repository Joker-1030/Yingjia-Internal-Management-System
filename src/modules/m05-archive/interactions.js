      ...
      function openRestore(id) {
        ...
        $("#restoreForm").onsubmit = (e) => {
          ...
          closeOverlay();
          renderPage();
          toast(item.targetKind === "contact" ? "恢复成功" : "恢复成功");
        };
      }
