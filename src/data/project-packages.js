      ...
      // 字段仅包含 PRD 8.2 已确认的：采购包编号、采购包名称、状态（正常/停用）、有效期、创建时间、最近编辑时间、课程方向。
      ...
      const projectPackages = [
        {
          ...
          lastEditedAt: "2026-08-18 14:20:00",
          directions: [
        ...
        },
        {
          ...
          lastEditedAt: "2026-05-10 11:05:00",
          directions: [
