...
城市 -> 当前唯一 PM 地市责任 -> 客户维系 / 任务 / 项目 / 销售范围 / 商机责任
```
...
城市仅维护一条当前唯一有效 PM 地市责任，统一用于客户维系、任务、项目与销售。PM 地市交接或直接调整同步迁移适用任务、项目和全部未落选商机，商机迁移失败纳入既有原子性边界；已落选商机和历史月份目标不改变。员工停用保留责任组独立处理例外，见 DEC-209“决策”第 6-7 项。
