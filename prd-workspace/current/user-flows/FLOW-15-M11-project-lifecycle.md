...
培训项目当前自动完成所需满意度仅包括项目、主讲师及已选择的辅讲师评分；助教不评价，缺少助教评分不产生`待评价`或阻止完成。详见 `prd-workspace/current/modules/M11-project-management.md` → §12.4“满意度”、`prd-workspace/current/acceptance/M11.md` → AC-M11-23。
