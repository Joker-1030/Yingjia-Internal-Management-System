      ...
      const operationPermissionCatalog = [
        ...
        ["approvals.withdraw", "approvals", "撤回本人发起的审批"],
        ["approvals.transfer", "approvals", "转交审批"],
        ["approvals.countersign", "approvals", "动态加签"],
        ["approvals.append_cc", "approvals", "审批中追加抄送"],
        ["approvals.admin_proxy", "approvals", "管理员代办"],
