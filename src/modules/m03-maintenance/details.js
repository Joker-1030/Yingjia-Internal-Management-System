      function openTaskDetail(id) {
        ...
        const isEventTask = ["生日关怀", "节假日关怀"].includes(t.type);
        ...
        $("#campaignForm").onsubmit = (e) => {
          ...
          if (c) {
            ...
            const newCampaign = {
              ...
              ...commonData,
              createdAt: commonData.updatedAt,
