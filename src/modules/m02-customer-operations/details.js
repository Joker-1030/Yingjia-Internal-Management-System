      ...
      function openCustomerForm(id) {
        ...
        const levels =
          currentUser.role === "pm"
            ...
            : ["省公司", "市公司", "区县公司"];
        openModal(
          `<div class="modal-head"><div class="modal-title">新增客户单位</div><button class="icon-btn close" data-close>×</button></div><form id="customerForm"><div class="modal-body"><div class="form-grid"><div class="form-group"><label class="form-label">行业 *</label><select class="input" id="cfIndustry" required>${industries
            .filter((x) => x.enabled)
